...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addIntegerOption(opt => opt.setName('qte50plus').setDescription('Nombre de RDV ligne 2 (+50 RDV)').setRequired(true))
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.isChatInputCommand() && interaction.commandName === 'facture') {
        ...
        const qte23      = interaction.options.getInteger('qte50plus');
